    ...
    <tbody>
        <c:forEach var="map" items="${gridItem}" varStatus="loopCounter">
            <tr>
                ...
                <td class="right"><a class="btn-floating" href="${baseUrl}/${map.id}"><i class="material-icons">info</i></a> <sec:authorize
                        access="hasRole('ADMIN')">
                        <a class="btn-floating orange" href="${baseUrl}/${map.id}/edit"><i class="material-icons">edit</i></a>
                        <a class="btn-floating red" href="${baseUrl}/${map.id}/delete"><i class="material-icons">delete</i></a>
                    </sec:authorize></td>
            </tr>
        </c:forEach>
    </tbody>
