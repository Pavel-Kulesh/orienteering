	...
	<div class="container">
		<div class="row">
			<div class="col offset-l2 s12 right-align" style="margin: 20px">
				...
				<a class="grey-text text-lighten-3" style="margin-right: 20px" target="_blank" href="https://raw.githubusercontent.com/dzhivushko/G-JD2-09-11_pavelkulesh/master/docs/mindMup(1).png?token=AkVOYUKXWAjKCdL09IptHrzaktJTJQBMks5cIjDqwA%3D%3D">MindMup</a> <a class="grey-text text-lighten-3" style="margin-right: 20px" target="_blank"
